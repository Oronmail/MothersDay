      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none space-y-6" dir="rtl">
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-2">
            ...
            <li><strong>חשבון משתמשת (אם פתחת חשבון):</strong> כתובת הדוא״ל, כתובות שמורות, סל הקניות ורשימת המשאלות שלך.</li>
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-2">
            ...
            <li>ניהול החשבון, סל הקניות ורשימת המשאלות</li>
          ...
          <p className="text-muted-foreground">
            ...
            רשימת המשאלות והתחברות לחשבון — וחלקם משמשים למדידה סטטיסטית (Google Analytics).
