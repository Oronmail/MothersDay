      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-10 text-right leading-relaxed" dir="rtl">
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              לאחר אישור התשלום תישלח אלייך הודעת אישור הזמנה לכתובת הדוא״ל שמסרת, הכוללת את פרטי ההזמנה, וכן תופק חשבונית/קבלה באופן אוטומטי באמצעות ספק הסליקה. אם לא קיבלת את המסמך, ניתן לפנות אלינו בדוא״ל ונשלח אותו אלייך.
            </p>
            <p className="text-muted-foreground">
              <strong>קודי הנחה:</strong> העסק רשאי להציע מעת לעת קודי הנחה או מבצעים. קוד הנחה חל בהתאם לתנאיו כפי שפורסמו (למשל: הטבה להזמנה ראשונה בלבד, אי-תחולה על מארזים), אין כפל הטבות או מבצעים, וההנחה מחושבת ומוצגת בעמוד סיכום ההזמנה לפני התשלום. העסק רשאי לשנות או להפסיק מבצע או קוד הנחה בכל עת, מבלי לפגוע בהזמנות שכבר בוצעו.
            </p>
          </section>
